import { Interaction, User, TextChannel, InteractionType, AutocompleteInteraction } from "discord.js";
import { BotClient } from "../../types";
import { ErrorMessage } from "../classes/Messages";
import { isBotTester } from "../utilities/genericTools";
import { ANSIControlCharactersRegExp, ANSIControlCharactersRegExpString } from "../utilities/regexHell";
...
export const handleError = async (
    ...
    const errorReply = new ErrorMessage(
        ...
        }\` has encountered an error while executing the interaction${isBotTester(user.id)
