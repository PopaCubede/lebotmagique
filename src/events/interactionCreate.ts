import { AutocompleteInteraction, Events, Interaction, InteractionType } from "discord.js";
import { AnyContextMenuCommand, AutoCompleteCommand, BotClient, BotEvent, SlashCommand } from "../../types";
import chalk from "chalk";
import { Emojis } from "../assets/enums";
    ...
    async execute(client: BotClient, interaction: Interaction) {
        ...
        if (
            ...
            if (interaction.isChatInputCommand()) {
                ...
                try {
                    await (command as SlashCommand).execute(interaction, client);
                } catch (error) {
                ...
                embeds: [
                    {
                        ...
                        description: `Sorry, <@${client.user.id
